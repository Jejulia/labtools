...
from labtools import __version__
...
app = typer.Typer(
    name="labtools",
    help="Various tools for Agilent MS-based quantification",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]labtools[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the labtools package.",
    ),
):
